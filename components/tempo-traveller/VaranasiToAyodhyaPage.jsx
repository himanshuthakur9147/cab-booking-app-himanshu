...
<button onClick={() => onSelect()} className="w-full py-3 text-sm font-bold text-white rounded-lg bg-[#0f6ec8] hover:bg-[#0a4a8f] transition-colors">Book {vehicle.badge} Tempo</button>
</div>
</div>
);
}
...
{/* Top Contact Bar */}  
  <div className="bg-[#0f6ec8] py-2 px-4 mt-16 md:mt-0">  
    <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">  
      <p className="text-white text-xs font-medium">Varanasi to Ayodhya Trusted Tempo Traveller Services</p>  
  ...
  <div className="bg-gray-50 border-b border-gray-200 py-2 px-4">  
    <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-2 text-xs text-gray-500">  
      ...
      <span className="text-[#0f6ec8] hover:underline cursor-pointer">Outstation Tempo Travellers</span><span>/</span>  
      <span className="text-gray-900 font-medium">Varanasi to Ayodhya Tempo Traveller</span>  
    </div>  
  </div>  

  {/* === HERO SECTION === */}  
  <div className="relative flex flex-col items-center justify-start pt-16 pb-20 px-4 min-h-[85vh]">  
    <div  
    ...
    <div className="text-center z-10 mb-6 mt-4">  
      <h1 className="uppercase font-black text-3xl md:text-5xl text-white tracking-tighter drop-shadow-2xl">  
        Varanasi to Ayodhya Tempo Traveller  
      </h1>  
    </div>  
    <div className="w-[80%] md:w-[60%] max-w-4xl z-10" id="booking">  
      <div className="bg-white rounded-xl shadow-2xl border border-gray-100 w-full pb-12">  
        ...
        <div className="flex justify-center -mt-10 relative z-30">  
          <button  
            ...
            className={`group flex items-center gap-4 px-10 md:px-16 py-3 md:py-4 rounded-xl font-bold uppercase text-lg md:text-xl transition-all duration-300 shadow-xl transform active:scale-95 ${  
              !pickupLocation?.trim()  
                ? "bg-slate-300 text-slate-500 cursor-not-allowed"  
                : "bg-[#0f6ec8] hover:bg-[#0a4a8f] text-white"  
            }`}  
          >  
            Search Cabs  
    ...
    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 w-[90%] md:w-[70%] z-10">  
      ...
      <div className="bg-white/10 backdrop-blur-md p-4 rounded-xl border border-white/20 flex items-center gap-4">  
        ...
        <div><h4 className="text-white font-bold text-sm">24/7 Support</h4><p className="text-gray-200 text-[11px] uppercase font-medium">Always Here</p></div>  
      </div>  
    </div>  
  </div>  

  {/* Feature Icons Default Setup */}  
  <FeatureCards />  
  ...
  {/* CTA Strip */}  
  <section className="bg-gradient-to-r from-[#0f6ec8] to-[#082e5c] py-12 px-6 text-center">  
    <h2 className="text-2xl font-extrabold text-white mb-3">Book Your Varanasi to Ayodhya Trip Today</h2>  
  ...
  <a href="tel:+919044019511" aria-label="Call Now" className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#0f6ec8] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">  
