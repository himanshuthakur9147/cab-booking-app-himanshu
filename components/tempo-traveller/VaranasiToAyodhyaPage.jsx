...
const routeDetails = [
  { detail: "Distance", info: "200 km (actual ~210â€“220 km with city approaches)" },
  { detail: "Drive Time", info: "3.5 to 4 hours (4â€“5 hrs with stops/traffic)" },
  { detail: "Route", info: "NH19 east to Sultanpur, then NH330/NH28 via Faizabad (Rama Path)" },
  { detail: "Road Condition", info: "Excellent 4â€“6 lane national highways; smooth asphalt, well-lit" },
  { detail: "Best Departure Time", info: "5:00â€“5:30 AM for day trip (reach Ayodhya by 9â€“10 AM)" },
  { detail: "Best Return Time", info: "5:00 PM from Ayodhya (arrive Varanasi 9â€“10 PM)" },
  { detail: "Tolls & Fuel Stops", info: "3â€“4 tolls (~Rs 400â€“500 total, included); dhabas at Sultanpur & Faizabad" },
...
const attractions = [
  ...
  },
  {
    ...
    icon: "ðŸ›•",
    desc: "The Ram Lalla darshan at Ram Janmabhoomi is the centrepiece of this pilgrimage. Queue time before 10 AM on weekdays runs 1â€“2 hours on a normal day. Three hours is the right allocation for the full visit â€” security check, queue, darshan, and exit. Phones are strictly not permitted inside the complex.",
    tip: "Leave phones in the tempo traveller. Traditional dress required â€” shorts and sleeveless clothing are turned away.",
  },
  {
    name: "Kanak Bhawan",
...
const packageOptions = [
  {
    ...
    desc: "Works for groups that have already spent time in Varanasi and are adding Ayodhya as a focused pilgrimage extension. 5 AM departure covers Hanuman Garhi, Ram Janmabhoomi, Kanak Bhawan, and Saryu Ghat â€” back in Varanasi by 9 PM.",
  },
  {
    days: "Two Days",
    icon: "ðŸŒ…",
...
const vehicleGuide = [
  {
    size: "9 Seater",
    for: "Small family of 6â€“8 people",
  ...
  {
    size: "12 Seater",
    for: "Medium family groups of 10â€“12 people",
  ...
  {
    size: "16 Seater",
    for: "Extended families and religious groups of 13â€“16",
  ...
  {
    size: "20 Seater",
    for: "Large joint families and temple trust groups of 17â€“20",
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yes. The round trip package is the most commonly booked option. Round trip for a 12 seater starts at Rs 14,000. The round trip package includes the vehicle for the full day in Ayodhya with driver waiting at every stop â€” not just the two-way transfer.",
  },
  {
    question: "How far in advance should I book?",
    answer: "For regular weekday travel, 3â€“5 days advance is generally sufficient. For weekend travel, 1â€“2 weeks. For Ram Navami, Diwali, Parikrama Panchami, and other major Ayodhya festival dates, book 3â€“4 weeks in advance. Since the 2024 Ram Lalla Temple consecration demand during festival periods has increased significantly.",
  },
  {
    question: "Is there a 9 seater tempo traveller available from Varanasi to Ayodhya?",
    answer: "Yes. The 9 seater is the right option for small family pilgrimages of 6â€“8 people with moderate luggage. One way fare starts at Rs 6,000 and return package at Rs 11,000. For families of 8 or more carrying substantial pilgrimage luggage or travelling with elderly members who need extra space, the 12 seater is the better choice.",
  },
  {
  ...
  },
  {
    ...
    answer: "A cab seats 4â€“6 people. A 12 seater tempo traveller seats 10â€“12 people. For groups of 8 or more the per head cost of the tempo traveller is consistently lower than booking multiple cabs. Beyond cost, the tempo traveller keeps the entire group in one vehicle for the full day â€” no separate arrival times at Ram Janmabhoomi, no coordinating two drivers through Ayodhya.",
  },
  {
    ...
    <>
      ...
      <section className="max-w-5xl mx-auto px-5 py-12 text-gray-800">
        <h1 className="text-3xl md:text-4xl font-bold text-center text-[#2482c2] mb-6">
          Varanasi to Ayodhya Tempo Traveller â€” Yatra Travel India
        </h1>
        <p className="text-lg leading-relaxed text-center mb-6">
          Kashi has the Ganga and one of the most powerful Jyotirlingas in India. Ayodhya has the Ram Janmabhoomi and the river where Lord Ram himself is said to have taken his final departure from this world. Putting both in the same journey is not just a logistical convenience â€” for millions of pilgrims it is the natural way these two sacred cities were always meant to be visited. Together.
        </p>
        <p className="text-lg leading-relaxed text-center mb-6">
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-6">Fixed all-inclusive fares. Fuel, tolls on NH19 and NH28, parking, and driver allowance â€” all included. The number confirmed at booking is the number paid when the group returns to Varanasi.</p>
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-[#2482c2]">Route & Distance â€” Varanasi to Ayodhya</h2>
          </div>
          <p className="text-gray-700 mb-6">
            Varanasi â†’ Jaunpur â†’ Sultanpur â†’ Faizabad â†’ Ayodhya. NH19 becoming NH28. 200 km. 3.5 to 4 hours on a normal day. Leave at 5 in the morning and the group is walking into Hanuman Garhi before 9 AM with the entire day still ahead.
          </p>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#2482c2] mb-4">
            Ayodhya â€” What to See & What Every Group Should Know
          </h2>
          <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10">
            An honest account of what a group spending one day in Ayodhya actually sees, does, and experiences at each stop â€” not a list of identical two-line descriptions.
          </p>
      ...
      <section className="py-14 bg-[#f0f7ff]">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#2482c2] mb-8">
            Departure Timing â€” The Decision That Changes Everything
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-green-50 border border-green-300 rounded-2xl p-6 shadow-md">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2"><FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" /><span>Reach Ayodhya by 8:30â€“9:00 AM</span></li>
                ...
                <li className="flex items-start gap-2"><FaCheckCircle className="text-green-500 mt-1 flex-shrink-0" /><span>Ram Lalla queue before the daily peak (1â€“2 hrs)</span></li>
            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-6 shadow-md">
              ...
              <ul className="space-y-2 text-gray-700">
                <li className="flex items-start gap-2"><span className="text-red-400 mt-1 flex-shrink-0">âœ—</span><span>Reach Ayodhya at 11:30 AM</span></li>
                <li className="flex items-start gap-2"><span className="text-red-400 mt-1 flex-shrink-0">âœ—</span><span>Join the midday Ram Lalla queue (4â€“6 hrs on weekends)</span></li>
                <li className="flex items-start gap-2"><span className="text-red-400 mt-1 flex-shrink-0">âœ—</span><span>Complete darshan between 4:00â€“5:00 PM</span></li>
                <li className="flex items-start gap-2"><span className="text-red-400 mt-1 flex-shrink-0">âœ—</span><span>Drive back through the evening traffic</span></li>
                <li className="flex items-start gap-2"><span className="text-red-400 mt-1 flex-shrink-0">âœ—</span><span>Reach Varanasi tired, having seen significantly less</span></li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#2482c2] mb-10">
            One Day, Two Days, or Three Days â€” Which One Is Right?
          </h2>
      ...
      <section className="py-14 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 mb-8">The question is not which vehicle sounds right â€” it is which vehicle is right for the specific group you actually have.</p>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-[#2482c2] mb-8">
            Before Anyone Gets in the Vehicle â€” Five Things
          </h2>
          <div className="space-y-4">
      ...
      <section className="max-w-4xl mx-auto my-12 px-4">
        <h2 className="text-3xl font-bold text-center text-[#2482c2] mb-8">
          Frequently Asked Questions â€” Varanasi to Ayodhya Tempo Traveller
        </h2>
