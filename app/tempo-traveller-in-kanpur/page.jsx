        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {["12 and 16 Seater Available", "Luxury Tempo Traveller", "Fully Air Conditioned", "Fixed Fare · No Hidden Charges"].map((b) => (
              <span key={b} className="bg-white/10 text-white text-xs font-semibold px-4 py-1.5 rounded-full border border-white/30">{b}</span>
            ))}
          </div>
            ...
            <div className="flex flex-wrap gap-1 bg-gray-100 rounded-lg p-1 mb-5">
              {tabs.map((tab) => (
                <button
                  ...
                  className={"flex-1 min-w-[70px] py-2 px-3 text-xs font-semibold rounded-md transition-all " + (activeTab === tab ? "bg-white text-[#0f6ec8] shadow" : "text-gray-500 hover:text-gray-700")}
                >
                  {tab}
                </button>
              ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
              ...
              <div>
                ...
                <select value={vtype} onChange={(e) => setVtype(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-[#0f6ec8]">
                  ...
                  {VEHICLES.map((v) => (
                    <option key={v.badge}>{v.title}</option>
                  ))}
                </select>
              </div>
              <button onClick={handleSearch} className="bg-[#0f6ec8] hover:bg-[#0a4a8f] text-white font-bold text-sm py-3 px-6 rounded-lg transition-colors">
                Search
              </button>
            </div>
          </div>
      ...
      <div className="bg-[#f8faff] border-b border-gray-200 py-4 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[
            ...
            <div key={item.title} className={"flex items-start gap-3 px-4 py-3 " + (i < 3 ? "border-r border-gray-200" : "")}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-10">
          <p className="text-sm text-blue-800 leading-relaxed">
            ...
            <strong>12 seater, 16 seater, and Luxury Tempo Traveller available.</strong> Fully AC, clean, pushback seats, experienced
            drivers. Transparent pricing — fuel, tolls, and driver allowance all included. Call <strong>9044019511</strong> to book.
          </p>
        </div>
        ...
        {/* ROUTES TABLE */}
        <h2 className="text-xl font-bold text-[#16a34a] mb-4 pl-4 border-l-4 border-green-500">
        ...
        {/* TAGS */}
        <h2 className="text-xl font-bold text-[#ff6b35] mb-4 pl-4 border-l-4 border-[#ff6b35]">Perfect For</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          <div className="border border-blue-200 rounded-xl overflow-hidden">
            ...
            <ul className="list-none m-0 p-0">
              {INCLUDED.map((item, i) => (
                <li key={item} className={"px-5 py-3 text-sm font-semibold text-[#1e40af] border-b border-blue-100 last:border-0 " + (i % 2 === 0 ? "bg-[#f8faff]" : "bg-white")}>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="border border-blue-200 rounded-xl overflow-hidden">
            ...
            <ul className="list-none m-0 p-0">
              {EXCLUDED.map((item, i) => (
                <li key={item} className={"px-5 py-3 text-sm font-semibold text-gray-700 border-b border-blue-100 last:border-0 " + (i % 2 === 0 ? "bg-[#f9fafb]" : "bg-white")}>
                  {item}
                </li>
              ))}
            </ul>
        ...
        {/* OUTSTATION */}
        <h2 className="text-xl font-bold text-[#ff6b35] mb-6 pl-4 border-l-4 border-[#ff6b35]" id="attractions">Popular Outstation Routes from Kanpur</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          ...
          {WHY_CARDS.map((w) => (
            <div key={w.title} className="bg-white border border-gray-200 rounded-xl p-5 flex items-start gap-4 hover:border-[#0f6ec8] transition-colors">
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#0f6ec8" strokeWidth="2.5">
        ...
        <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-5 mb-12">
          <p className="text-sm text-yellow-800 leading-relaxed">
            ...
            For luxury tempo travellers during peak wedding season, book <strong>1 to 2 weeks ahead.</strong>
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#0f6ec8] to-[#082e5c] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          ...
          <div className="flex gap-3 flex-wrap flex-shrink-0">
            ...
            <a href="https://wa.me/919044019511" target="_blank" rel="noopener noreferrer" className="bg-white/10 hover:bg-white/20 text-white font-bold text-sm px-7 py-3 rounded-lg border border-white/40 transition-colors flex items-center gap-2">
...
/* ═══════════════════════════════════════════
   VEHICLE CARD — all blue, label: value format
═══════════════════════════════════════════ */
