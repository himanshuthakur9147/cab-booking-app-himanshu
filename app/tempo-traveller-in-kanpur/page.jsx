...
const VEHICLES = [
  { badge: "12 Seater", title: "12 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "12 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹23/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "Pushback Seats", "Lucknow Trip", "Family Tours"], color: "blue" },
  { badge: "14 Seater", title: "14 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "14 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹24/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "Pushback Seats", "Corporate Tours", "Family Trips"], color: "blue" },
  { badge: "16 Seater", title: "16 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "16 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹26/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "Extra Legroom", "Varanasi Trip", "Office Outings"], color: "blue" },
  { badge: "18 Seater", title: "18 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "18 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹28/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "More Legroom", "Delhi Trip", "Group Tours"], color: "blue" },
  { badge: "20 Seater", title: "20 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "20 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹30/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "Max Luggage", "Wedding Baraat", "Pilgrimage"], color: "orange" },
  { badge: "24 Seater", title: "24 Seater Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "24 Passengers + 1 Driver" }, { label: "Starting Fare", value: "₹35/km" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Full AC", "Large Groups", "Corporate Events", "Pilgrimage"], color: "orange" },
  { badge: "Luxury", title: "Luxury Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "9–16 Passengers + 1 Driver" }, { label: "Starting Fare", value: "On Request" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Premium AC", "LED Lighting", "Music System", "Charging Points"], color: "blue" },
  { badge: "Maharaja", title: "Maharaja Tempo Traveller in Kanpur", specs: [{ label: "Seating Capacity", value: "9–16 Passengers + 1 Driver" }, { label: "Starting Fare", value: "On Request" }, { label: "Driving Charges", value: "₹500/day" }, { label: "Minimum Km/Day", value: "250 km/day" }, { label: "Facility", value: "AC, Pushback Seat, Music System" }], tags: ["Sofa Seats", "Full Recline", "VIP Travel", "Grand Weddings"], color: "orange" },
];
...
const USE_TAGS = ["Kanpur Local Sightseeing", "Wedding Guest Transfers", "Baraat Transport Kanpur", "VIP Guest Movement", "Kanpur to Lucknow Group Travel", "Kanpur to Varanasi Pilgrimage", "Kanpur to Prayagraj Kumbh", "Kanpur to Delhi Outstation", "Corporate Office Outings", "Family Multi-Day Trips", "Religious Pilgrimage Groups", "Airport Group Transfers"];
...
const EXCLUDED = ["Toll tax charges (as per actual during the trip)", "State entry tax / permit charges (if applicable)", "Parking charges (as per actual at locations)", "Driver night allowance (₹500 for Tempo Traveller, if applicable)", "Luggage carrier charges"];
...
const OUTSTATION_ROUTES = [
  { title: "Kanpur to Lucknow Tempo Traveller",   meta: ["~80 km", "1–2 Hours", "Most Booked Route"],    desc: "The most popular outstation route from Kanpur. Whether it is a family outing, corporate tour, wedding travel, or a pilgrimage trip, a Kanpur to Lucknow tempo traveller ensures everyone can travel together in one vehicle. Our experienced drivers know the Kanpur to Lucknow route well, ensuring timely pickup and drop and smooth highway travel. Both standard and luxury tempo traveller options available for this route." },
  { title: "Kanpur to Prayagraj Tempo Traveller", meta: ["~190 km", "3–4 Hours", "Pilgrimage and Family"], desc: "Make your group travel from Kanpur to Prayagraj simple and comfortable by hiring a tempo traveller. Perfect for families, friends, corporate teams, wedding guests, or pilgrims. Our 12 seater and 16 seater tempo travellers in Kanpur are fully air-conditioned, spacious, and feature reclining seats with enough room for all luggage. The driver handles all traffic and directions so your group can relax for the full journey." },
  { title: "Kanpur to Varanasi Tempo Traveller",  meta: ["~330 km", "5–6 Hours", "Kashi Pilgrimage"],     desc: "Travelling from Kanpur to Varanasi with a group is easy and stress-free when you hire a tempo traveller. Whether it is a family trip, office tour, wedding party, or a pilgrimage journey to Kashi, a Kanpur to Varanasi tempo traveller keeps everyone together. Long distance travel is comfortable with reclining seats, full AC, and plenty of luggage space. The driver knows the route well and ensures timely pickups and drop-offs." },
  { title: "Kanpur to New Delhi Tempo Traveller",  meta: ["~450 km", "6–7 Hours", "Family and Corporate"], desc: "Skip the hassle of multiple cars and long drives by hiring a tempo traveller from Kanpur to New Delhi. Perfect for family trips, office tours, wedding parties, or pilgrimage journeys. Our 12 seater and 16 seater tempo travellers are fully air conditioned and have reclining seats with enough room for luggage, making the long-distance journey smooth and relaxing. The driver knows the route well and ensures timely arrival." },
];
...
const FAQS = [
  ...
  { q: "Will the tempo traveller come to my exact pickup location?",       a: "Yes, in most cases the vehicle will come right to your doorstep. Whether you are near the railway station, a hotel, or any residential area in Kanpur, pickup can be arranged easily. Just share the correct location while booking." },
  { q: "Are there any hidden charges in tempo traveller rental?",          a: "This depends on the service provider. A good rental company will clearly explain everything — like toll tax, parking, and driver allowance. At Yatra Travel India it is always better to ask once before confirming so there are no surprises later." },
  ...
  { q: "Is there a difference between normal and luxury tempo traveller?", a: "Yes, there is a noticeable difference. A normal tempo traveller is simple and budget-friendly. A luxury tempo traveller comes with better seats, more leg space, charging points, and sometimes even extra features like TV or lighting." },
...
/* ── TITLE helper — blue with left border ── */
const SectionTitle = ({ children, color = "blue", orange = false, green = false, id }) => {
  const borderColor = orange ? "border-[#ff6b35]" : green ? "border-green-500" : "border-[#0f6ec8]";
  const textColor   = orange ? "text-[#ff6b35]"   : green ? "text-[#16a34a]"   : "text-[#0f6ec8]";
  return (
    <h2 id={id} className={`text-xl font-bold ${textColor} mb-6 pl-4 border-l-4 ${borderColor}`}>
      {children}
    </h2>
  );
};
    ...
    <>
      ...
      <div className="bg-[#0f6ec8] py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          <p className="text-white text-xs font-medium">Kanpur&apos;s Trusted Tempo Traveller — Weddings, VIP Travel, Lucknow, Varanasi, Prayagraj and Delhi</p>
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-2 text-xs text-gray-500">
          <Link href="/" className="text-[#0f6ec8] hover:underline">Home</Link><span className="text-gray-300">/</span>
          <Link href="/" className="text-[#0f6ec8] hover:underline">Services</Link><span className="text-gray-300">/</span>
      ...
      <section className="bg-gradient-to-br from-[#0f6ec8] via-[#0a4a8f] to-[#082e5c] py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-blue-200 text-center text-sm mb-5">Weddings and VIP Travel · Lucknow · Varanasi · Prayagraj · Delhi · Agra · Local Sightseeing</p>
          ...
          <div id="booking" className="bg-white rounded-xl shadow-2xl max-w-4xl mx-auto p-6 md:p-8">
            <div className="flex flex-wrap gap-1 bg-gray-100 rounded-lg p-1 mb-5">
              {tabs.map((tab) => (
                <button key={tab} onClick={() => setActiveTab(tab)} className={`flex-1 min-w-[70px] py-2 px-3 text-xs font-semibold rounded-md transition-all ${activeTab === tab ? "bg-white text-[#0f6ec8] shadow" : "text-gray-500 hover:text-gray-700"}`}>{tab}</button>
              ))}
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
              ...
              <div>
                ...
                <input value={toCity} onChange={(e) => setToCity(e.target.value)} placeholder="Destination" className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-[#0f6ec8] focus:ring-2 focus:ring-blue-100" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1.5">Vehicle Type</label>
                <select value={vtype} onChange={(e) => setVtype(e.target.value)} className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-[#0f6ec8]">
                  <option>Select Vehicle</option>
                  {VEHICLES.map((v) => <option key={v.badge}>{v.title}</option>)}
                </select>
              </div>
              <button onClick={handleSearch} className="bg-[#0f6ec8] hover:bg-[#0a4a8f] text-white font-bold text-sm py-3 px-6 rounded-lg transition-colors">Search</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="bg-[#f8faff] border-b border-gray-200 py-4 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4">
          {[{ title: "On-Time Pickup", sub: "Pickup from your exact location" }, { title: "Clean and Well Maintained", sub: "Regularly serviced before every trip" }, { title: "Transparent Pricing", sub: "Fuel, toll, driver allowance included" }, { title: "Professional Drivers", sub: "Know all Kanpur routes and highways" }].map((item, i) => (
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mb-10">
          <p className="text-sm text-blue-800 leading-relaxed">Yatra Travel India offers <strong>tempo traveller on rent in Kanpur</strong> for local sightseeing, wedding guest transfers, VIP movement, and outstation trips to Lucknow, Varanasi, Prayagraj, Delhi, and Agra. <strong>12 seater, 16 seater, and Luxury Tempo Traveller available.</strong> Fully AC, clean, pushback seats, experienced drivers. Transparent pricing — fuel, tolls, and driver allowance all included. Call <strong>9044019511</strong> to book.</p>
        </div>

        <div className="mb-12">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#0f6ec8] mb-5 pl-4 border-l-4 border-[#ff6b35]">Tempo Traveller on Rent in Kanpur — Comfortable Group Travel for Every Occasion</h2>
            ...
            <tbody>
              {OPTIONS_TABLE.map((row, i) => (
                <tr key={i} className={`${i % 2 === 0 ? "bg-[#f8faff]" : "bg-white"} hover:bg-blue-50 transition-colors`}>
                  ...
                  <td className="py-3 px-5 border-r border-b border-gray-100"><span className={`text-xs font-bold px-3 py-1 rounded-full border ${row.ac === "Premium AC" ? "bg-orange-50 text-orange-700 border-orange-200" : "bg-blue-50 text-[#0f6ec8] border-blue-200"}`}>{row.ac}</span></td>
        ...
        {/* ROUTES TABLE */}
        <SectionTitle green>Tempo Traveller Hire in Kanpur — Key Routes</SectionTitle>
        <div className="overflow-x-auto rounded-xl border border-gray-200 mb-3">
          <table className="w-full text-sm min-w-[480px]">
            <thead><tr className="bg-[#0f6ec8]">{["Route", "Distance", "Vehicle", "Booking"].map((h) => <th key={h} className="text-left text-white font-bold text-xs py-4 px-5 border-r border-white/20 last:border-0">{h}</th>)}</tr></thead>
            <tbody>
              {ROUTES_TABLE.map((row, i) => (
                <tr key={i} className={`${i % 2 === 0 ? "bg-[#f8faff]" : "bg-white"} hover:bg-blue-50`}>
                  ...
                  <td className="py-3 px-5 border-b border-gray-100"><a href="tel:+919044019511" className="inline-flex items-center gap-1.5 bg-[#0f6ec8] hover:bg-[#0a4a8f] text-white text-xs font-bold px-4 py-1.5 rounded-full transition-colors"><FaPhoneAlt size={10} /> Call Now</a></td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <SectionTitle orange>Perfect For</SectionTitle>
          ...
          {FEATURES.map((f) => (
            <div key={f.title} className="bg-[#f8faff] border border-blue-100 rounded-xl p-6 text-center">
              <div className="w-12 h-12 bg-[#0f6ec8] rounded-xl flex items-center justify-center mx-auto mb-3">
                <svg viewBox="0 0 24 24" fill="#fff" width="22" height="22"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg>
              </div>
        ...
        {/* ── INCLUSIONS / EXCLUSIONS — NO SYMBOLS ── */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          <div className="border border-blue-200 rounded-xl overflow-hidden">
            ...
            <ul className="list-none m-0 p-0">
              {INCLUDED.map((item, i) => (
                <li key={item} className={`px-5 py-3 text-sm font-semibold text-[#1e40af] border-b border-blue-100 last:border-0 ${i % 2 === 0 ? "bg-[#f8faff]" : "bg-white"}`}>{item}</li>
              ))}
            </ul>
          </div>
          <div className="border border-blue-200 rounded-xl overflow-hidden">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-7 mb-10">
          {["Kanpur has a strong VIP and grand wedding culture. From big family weddings to high-profile business events, people in Kanpur prefer classy, well-managed, and comfortable travel. Whether it is a large wedding at a banquet hall, a destination wedding, or a VIP guest arrival, travel arrangements play a big role in making the event smooth and impressive.", "A luxury tempo traveller in Kanpur is a perfect choice for wedding guests and VIP movement. These vehicles are designed for premium travel, offering stylish interiors, soft pushback seats, extra legroom, and full air conditioning. Guests can travel together comfortably, without the rush and confusion of multiple cars.", "For weddings, a luxury tempo traveller on rent in Kanpur is commonly used to move baraat members, close relatives, and outstation guests between hotels, wedding venues, and function locations. For VIP guests, it ensures privacy, comfort, and a professional travel experience. Our drivers understand event timing and VIP travel needs and always ensure on-time pickup and smooth driving."].map((p, i) => <p key={i} className="text-[15px] text-gray-600 leading-relaxed mb-4 last:mb-0">{p}</p>)}
        </div>

        <SectionTitle>Why Luxury Tempo Travellers Are Popular for Weddings in Kanpur</SectionTitle>
        ...
        <SectionTitle orange id="attractions">Popular Outstation Routes from Kanpur</SectionTitle>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
        ...
        <SectionTitle>Why Book a Tempo Traveller with Yatra Travel India in Kanpur</SectionTitle>
          ...
          {WHY_CARDS.map((w) => (
            <div key={w.title} className="bg-white border border-gray-200 rounded-xl p-5 flex items-start gap-4 hover:border-[#0f6ec8] transition-colors">
              <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center flex-shrink-0">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#0f6ec8" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
              </div>
              <div><h4 className="text-sm font-bold text-gray-900 mb-1.5">{w.title}</h4><p className="text-xs text-gray-500 leading-relaxed">{w.desc}</p></div>
            </div>
          ))}
        </div>

        <div className="bg-yellow-50 border border-yellow-300 rounded-xl p-5 mb-12">
          <p className="text-sm text-yellow-800 leading-relaxed"><strong>Advance Booking Recommended:</strong> Kanpur tempo travellers get booked quickly during <strong>wedding season and long weekends.</strong> Booking <strong>4 to 7 days in advance</strong> is usually a safe choice. For luxury tempo travellers during peak wedding season, book <strong>1 to 2 weeks ahead.</strong> Multi-day outstation trips to Varanasi and Delhi should be confirmed early to secure vehicle and driver availability.</p>
        </div>

        <SectionTitle>Frequently Asked Questions — Tempo Traveller in Kanpur</SectionTitle>
        ...
        <div className="bg-gradient-to-r from-[#0f6ec8] to-[#082e5c] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-blue-200 text-sm max-w-xl">Enjoy stylish, comfortable group travel without any hassle. Weddings, VIP movement, Lucknow, Varanasi, Prayagraj, Delhi — call us with your group size and travel date. We handle everything else.</p>
          </div>
          <div className="flex gap-3 flex-wrap flex-shrink-0">
            <a href="tel:+919044019511" className="bg-[#ff6b35] hover:bg-[#e55a24] text-white font-bold text-sm px-7 py-3 rounded-lg transition-colors flex items-center gap-2"><FaPhoneAlt size={12} /> Call Now — +91 90440 19511</a>
            <a href="https://wa.me/919044019511" target="_blank" rel="noopener noreferrer" className="bg-white/15 hover:bg-white/25 text-white font-bold text-sm px-7 py-3 rounded-lg border border-white/40 transition-colors flex items-center gap-2"><FaWhatsapp size={14} /> WhatsApp Us</a>
          </div>
        </div>
  ...
  return (
    <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm hover:border-[#0f6ec8] hover:shadow-md transition-all">
      <div className="h-36 bg-gradient-to-br from-blue-50 to-blue-100 relative flex flex-col items-center justify-center gap-2">
        ...
        <span className={`absolute top-3 left-3 text-white text-xs font-bold px-3 py-1 rounded-full ${isOrange ? "bg-[#ff6b35]" : "bg-[#0f6ec8]"}`}>{vehicle.badge}</span>
      </div>
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-1 mb-3">
          {vehicle.tags.map((tag) => (
            <span key={tag} className={`text-[10px] font-semibold px-2 py-0.5 rounded-full border ${isOrange ? "bg-orange-50 text-orange-700 border-orange-200" : "bg-blue-50 text-[#0f6ec8] border-blue-200"}`}>{tag}</span>
          ))}
        </div>
        <button onClick={() => onSelect(vehicle.title)} className={`w-full py-2.5 text-xs font-bold text-white rounded-lg transition-colors ${isOrange ? "bg-[#ff6b35] hover:bg-[#e55a24]" : "bg-[#0f6ec8] hover:bg-[#0a4a8f]"}`}>
