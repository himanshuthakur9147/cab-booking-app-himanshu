...
function ST({ children, borderColor = "border-[#0f6ec8]", id }) {
  return (
    <h2 id={id} className={"text-xl font-bold text-gray-900 mb-6 pl-4 border-l-4 " + borderColor}>
      {children}
    </h2>
  );
}
  ...
  return (
    <div style={{ maxWidth: "100%", overflowX: "hidden" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
              ...
              {OPTIONS_TABLE.map((row, i) => (
                <tr key={i} className={(i % 2 === 0 ? "bg-[#f8faff]" : "bg-white") + " hover:bg-blue-50"}>
                  ...
                  <td className="py-3 px-4 border-r border-b border-gray-100">
                    <span className={"text-xs font-bold px-2.5 py-1 rounded-full border " + (row.ac === "Premium AC" ? "bg-orange-50 text-orange-700 border-orange-200" : "bg-blue-50 text-[#0f6ec8] border-blue-200")}>
                      {row.ac}
                    </span>
                  </td>
        ...
        {/* ROUTES TABLE */}
        <ST borderColor="border-green-500">Tempo Traveller Hire in Kanpur — Key Routes</ST>
        ...
        {/* TAGS */}
        <ST borderColor="border-[#ff6b35]">Perfect For</ST>
        ...
        {/* ── INCLUSIONS / EXCLUSIONS — both blue, no symbols ── */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          ...
          <div className="border border-blue-200 rounded-xl overflow-hidden">
            ...
            <ul className="list-none m-0 p-0">
              {INCLUDED.map((item, i) => (
                <li key={item} className={"px-5 py-3.5 text-sm font-semibold text-[#1e40af] border-b border-blue-100 last:border-0 " + (i % 2 === 0 ? "bg-[#f8faff]" : "bg-white")}>
                  {item}
                </li>
              ))}
            </ul>
          </div>
          {/* EXCLUDED — same blue text as included */}
          <div className="border border-blue-200 rounded-xl overflow-hidden">
        ...
        {/* OUTSTATION */}
        <ST borderColor="border-[#ff6b35]" id="attractions">Popular Outstation Routes from Kanpur</ST>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-12">
          {OUTSTATION_ROUTES.map((r) => (
            <div key={r.title} className="bg-white border border-gray-200 rounded-xl p-5 hover:border-[#0f6ec8] hover:shadow-md transition-all">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {r.meta.map((m) => <span key={m} className="text-xs text-gray-500 bg-gray-100 px-3 py-1 rounded-full">{m}</span>)}
              </div>
...
/* ═══════════════════════════════════════════
   VEHICLE CARD — image + label:value specs
═══════════════════════════════════════════ */
  ...
  return (
    <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm hover:border-[#0f6ec8] hover:shadow-md transition-all">
      ...
      <div className="p-5">
        ...
        {/* Specs — Label: Value left-aligned */}
