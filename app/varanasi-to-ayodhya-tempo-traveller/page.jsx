  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How much does a tempo traveller from Varanasi to Ayodhya cost?",
          "acceptedAnswer": { "@type": "Answer", "text": "A 12 seater tempo traveller from Varanasi to Ayodhya starts at Rs 14,000 for a round trip. All fares include fuel, tolls, parking and driver allowance." },
        },
        {
          "@type": "Question",
          "name": "How far is Varanasi to Ayodhya?",
          "acceptedAnswer": { "@type": "Answer", "text": "Varanasi to Ayodhya is 200 km via NH19 and NH28. Drive time is 3.5 to 4 hours." },
        },
        {
          "@type": "Question",
          "name": "Are phones allowed in Ram Janmabhoomi?",
          "acceptedAnswer": { "@type": "Answer", "text": "No. Mobile phones are strictly not permitted inside Ram Janmabhoomi complex at any security point." },
        },
      ],
    },
  ],
    ...
    <div style={{ maxWidth: "100%", overflowX: "hidden" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-6 pl-4 border-l-4 border-[#0f6ec8]">
          Choose Your Ride -- Varanasi to Ayodhya Tempo Traveller
        </h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-4 pl-4 border-l-4 border-[#0f6ec8]">
          Route and Distance -- Varanasi to Ayodhya
        </h2>
        <p className="text-sm text-gray-600 mb-5">Varanasi to Jaunpur to Sultanpur to Faizabad to Ayodhya. NH19 becoming NH28. 200 km. 3.5 to 4 hours on a normal day.</p>
        ...
        <p className="text-sm text-gray-500 mb-8">An honest account of what a group spending one day in Ayodhya actually sees, does, and experiences at each stop.</p>
        ...
        {/* DEPARTURE TIMING */}
        <h2 className="text-xl font-bold text-gray-900 mb-2 pl-4 border-l-4 border-[#0f6ec8]">
          Departure Timing -- The Decision That Changes Everything
        </h2>
        <p className="text-sm text-gray-500 mb-6">Choose your departure time wisely. It defines your entire pilgrimage day.</p>
